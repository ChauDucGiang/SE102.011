...
void CMap::Render()
{
	DebugOut(L"[INFO] Start render Map!\n");
	...
	DebugOut(L"[INFO] Finished render Map!\n");
}
...
void CMap::ExtractTileFromTileSet()
{
	...
	{
		int left = TileNum % TotalColumnsOfTileSet * TILE_WIDTH; // chia lấy phần dư * W
		int top = TileNum / TotalColumnsOfTileSet * TILE_HEIGHT; // chia lấy phần nguyên * H
